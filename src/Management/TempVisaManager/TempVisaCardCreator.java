...
public class TempVisaCardCreator {
    ...
    public static void deleteCardLineFromFile(String cardNumberToDelete) {
    ...
    private void showPaymentOptions(TempVisaCard Card) {
        ...
        if (choice == 0) {
            ...
            if (sourceCard != null) {
                ...
                archiveZeroBalanceCard(Card);
                deleteCardLineFromFile(Card.cardNumber);
            }
        } else if (choice == 1) {
            frame.dispose();
...
public static void archiveZeroBalanceCard(TempVisaCard tempCard) {
    ...
    try (
            FileWriter fw = new FileWriter(archivePath, true); // append mode
            BufferedWriter bw = new BufferedWriter(fw)
    ) {
        String cardNumber = tempCard.cardNumber;
