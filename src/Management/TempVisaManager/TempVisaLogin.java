...
public class TempVisaLogin {
    ...
    public static Color CHAMPAGNE = new Color(0xEBD2B8);
...
//back button icon
    ...
    public static TempVisaCard showLogin() {
        ...
        login.setBackground(SEAWEED);
        login.setForeground(CHAMPAGNE);
        login.setAlignmentX(Component.CENTER_ALIGNMENT);
        login.setMaximumSize(new Dimension(175, 50));
        login.setFont(new Font("Arial",Font.BOLD,16));


        JButton backButton = new JButton("Back",resizedBackIcon);
        ...
        backButton.setBackground(SOFT_GREEN);
        backButton.setForeground(CHAMPAGNE);
        backButton.setBorder(new RoundedBorder(12));
