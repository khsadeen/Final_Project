...
public class MainMenu {
    ...
    private static JButton createStyledButton(String text, Color bg, Color fg) {
        ...
        button.addMouseListener(new MouseAdapter() { //to see the action (if clicked or not)
            @Override
            public void mouseEntered(MouseEvent e) {
                button.setBackground(Elements.SOFT_GREEN);}//(if entered -> soft green)
            @Override
            public void mouseExited(MouseEvent e) {
                button.setBackground(originalBg);
            }//if not back to origin c
        });
