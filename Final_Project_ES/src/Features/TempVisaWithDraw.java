...
public class TempVisaWithDraw {
    ...
    public static void show(TempVisaCard card) {
        ...
        JButton backBtn = createStyledButton("Back",Elements.SOFT_GREEN,Elements.CHAMPAGNE);
        backBtn.setIcon(Elements.resizedBackIcon);
        ...
        JButton showBalance = createStyledButton("Show Balance",Elements.SOFT_GREEN,Elements.CHAMPAGNE);
        showBalance.addActionListener(e -> {
            JOptionPane.showMessageDialog(null,"Your Balance: "+card.balance+"₪");
        });
        ...
        JPanel otheraBut = new JPanel(new GridLayout(1,2,20,15));
        otheraBut.setBackground(Elements.BEIGE);
        otheraBut.add(backBtn);
        otheraBut.add(showBalance);
        otheraBut.setMaximumSize(new Dimension(400,60));
        otheraBut.setBorder(BorderFactory.createEmptyBorder(15,15,10,15));
